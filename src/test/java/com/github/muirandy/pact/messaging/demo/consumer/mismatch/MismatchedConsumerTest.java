package com.github.muirandy.pact.messaging.demo.consumer.mismatch;
...
class MismatchedConsumerTest {
    ...
    MessagePact mismatchedPact(MessagePactBuilder builder) {
        ...
        return builder.expectsToReceive("A mismatched message from websocket to kafka")
    ...
    @Test
    @PactTestFor(pactMethod = "mismatchedPact", providerType = ProviderType.ASYNCH)
