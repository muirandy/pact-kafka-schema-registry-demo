package com.github.muirandy.pact.messaging.demo.provider.mismatch;
...
import com.github.muirandy.pact.messaging.demo.provider.websocket.WebsocketClient;
...
@Provider("mismatchedProviderApp")
@Consumer("mismatchedConsumerApp")
@PactBroker(url = "http://localhost:9292")
class MismatchedProviderTest {
    ...
    @PactVerifyProvider("A mismatched message from websocket to kafka")
